...
function doGet(e){
  ...
  //read_google_sheet() function in Arduino Nano ESP32 sketch, is relate to the first code block
  //write_google_sheet() function in Arduino Nano ESP32 sketch, is relate to the second code block
  //----------------------------------------------------------------------------------
  //code block 1
  //send data to Arduino Nano ESP32
  ...
  //----------------------------------------------------------------------------------
  //code block 2
  //get command from Arduino Nano ESP32
